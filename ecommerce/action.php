			...
			echo "<form method='post' action='login_form.php'>";
				...
				if (!isset($_SESSION["uid"])) {
					...
					echo '
						 ...
						 <form action="payment_success2.php" method="post">
					
									
									<input type="hidden" name="custom" value="'.$_SESSION["uid"].'"/>
									<button type="submit" name="submitOrder"  class="btn btn-block boton  text-uppercase contact-btn"><i class="far fa-hand-point-right mr-2" ></i>Submit Order</button>
